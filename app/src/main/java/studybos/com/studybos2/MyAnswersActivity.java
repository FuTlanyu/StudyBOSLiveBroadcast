...
public class MyAnswersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化控件
        callBackButton=(Button)findViewById(R.id.my_answers_back_button);

        //设置按钮点击事件
        callBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MyAnswersActivity.this,LiveActivity.class);
        ...
        //设置recyclerview
        helpList= InitUtil.initMyAnswers();
        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.my_answers_recycler_view);
